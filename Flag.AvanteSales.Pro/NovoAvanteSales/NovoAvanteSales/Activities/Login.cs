...
namespace AvanteSales.Pro.Activities
{
    ...
    public class Login : Activity, TextView.IOnEditorActionListener
    {
        ...
        private static void AbrirSincronizacao()
        {
            ...
            i.PutExtra("codigoVendedor", spnEmpregado.Adapter != null && spnEmpregado.SelectedItem != null ? ((CSEmpregados.CSEmpregado)((CSItemCombo)spnEmpregado.SelectedItem).Valor).COD_EMPREGADO.ToString() : "0");
