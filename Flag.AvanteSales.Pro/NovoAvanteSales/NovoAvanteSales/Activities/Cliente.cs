...
{
    [Activity(Label = "Cliente", ScreenOrientation = ScreenOrientation.Portrait, Theme = "@style/AvanteSalesTheme2", WindowSoftInputMode = SoftInput.AdjustNothing)]
    public class Cliente : AppCompatActivity
    {
        ...
        ImageView btnPassoAnterior;
        ImageView btnProximoPasso;
        ...
        private bool m_FragmentCarregando;
        public bool FragmentCarregando
        {
            get
            {
                return m_FragmentCarregando;
            }
            set
            {
                m_FragmentCarregando = value;
            }
        }
        ...
        public List<string[]> GetListaProdutosNaoValidos()
        {
            return ListaProdutosNaoValidos;
        }

        public void AbrirDialogFragmentProdutosNaoValidosEscalonamento(List<string[]> produtosNaoValidos)
        {
            DialogFragmentProdutosNaoValidosEscalonamento digitacaoCombo = new DialogFragmentProdutosNaoValidosEscalonamento();

            ListaProdutosNaoValidos = produtosNaoValidos;

            digitacaoCombo.Show(SupportFragmentManager, "DialogFragmentProdutosNaoValidosEscalonamento");
        }
        ...
        private void FindViewsById()
        {
            ...
            btnPassoAnterior = FindViewById<ImageView>(Resource.Id.btnPassoAnterior);
            btnProximoPasso = FindViewById<ImageView>(Resource.Id.btnProximoPasso);
