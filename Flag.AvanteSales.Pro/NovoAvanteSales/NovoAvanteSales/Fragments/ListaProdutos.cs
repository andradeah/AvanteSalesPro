    ...
    public class ListaProdutos : Android.Support.V4.App.Fragment
    {
        ...
        private void Inicializacao()
        {
            ...
            if (((Cliente)Activity).LinhaSelecionada != null)
            {
                ...
                ((Cliente)Activity).FragmentCarregando = false;
        }
        ...
        private class ProdutosListViewBaseAdapter : BaseAdapter
        {
            ...
            public override View GetView(int position, View convertView, ViewGroup parent)
            {
                ...
                LinearLayout llStatusCategoria;
                ...
                if (convertView == null)
                {
                    ...
                    llStatusCategoria = convertView.FindViewById<LinearLayout>(Resource.Id.llStatusCategoria);
                    ...
                    lblU = convertView.FindViewById<TextView>(Resource.Id.lblU);
                    ...
                    convertView.SetTag(llStatusCategoria.Id, llStatusCategoria);
                    ...
                    convertView.SetTag(lblU.Id, lblU);
                }
                else
                {
                    ...
                    llStatusCategoria = (LinearLayout)convertView.GetTag(Resource.Id.llStatusCategoria);
                    ...
                    lblU = (TextView)convertView.GetTag(Resource.Id.lblU);
                ...
                if (produtoAtual.IND_PROD_TOP_CATEGORIA)
                    llStatusCategoria.SetBackgroundColor(Color.ParseColor("#009136"));
                else if (produtoAtual.IND_PROD_ESPECIFICO_CATEGORIA)
                    llStatusCategoria.SetBackgroundColor(Color.ParseColor("#03a9f4"));
                else
                    llStatusCategoria.SetBackgroundColor(Color.ParseColor("#7f7f7f"));
                ...
                if (IsBroker())
                {
                    lblU.Visibility = ViewStates.Gone;
                    imgVendaUltimaVisita.Visibility = ViewStates.Gone;
                    lblGC.Visibility = ViewStates.Gone;
                }
