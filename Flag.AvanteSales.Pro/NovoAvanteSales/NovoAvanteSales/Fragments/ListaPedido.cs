...
namespace AvanteSales.Pro.Fragments
{
    public class ListaPedido : Android.Support.V4.App.Fragment
    {
        ...
        private void Inicializacao()
        {
            ...
            {
                CSGlobal.ROTINA_VALIDACAO_PEDIDO = false;

                var pedido = CSPDVs.Current.PEDIDOS_PDV.Items.Cast<CSPedidosPDV.CSPedidoPDV>().Where(p => p.COD_PEDIDO == CSGlobal.CODIGO_VALIDACAO_PEDIDO).FirstOrDefault();
