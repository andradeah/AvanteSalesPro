...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "AvanteSales.Pro.dll" comes first in this list. */
		"AvanteSales.Pro.dll",
		"AvanteSales.SyncManager.dll",
		"AvanteSales.SyncManager.SQLLiteProvider.dll",
		"AvanteSales.SystemFramework.dll",
		...
		"Master.CompactFramework.Util.Compression.dll",
	};
