...
namespace AvanteSales
{
 ...
 Bitmap icon
        ...
        public void ConstroiIndices(UpdateStatus objMsg)
        {
            ...
            {
                case "1":
                    numeroTabelasTotal = 64;
                    break;
                case "2":
                    numeroTabelasTotal = 135;
                    break;
                case "3":
                    numeroTabelasTotal = 12;
                    break;
                case "9023":
                    numeroTabelasTotal = 83;
                    break;
                case "9123":
                    numeroTabelasTotal = 146;
                    break;
                case "9103":
                    numeroTabelasTotal = 75;
                    break;
                case "9120":
                    numeroTabelasTotal = 135;
                    break;
            ...
            //************** Inicio Construindo Indice da tabela ESCALONADA_BLOQUEIO_DESCONTO *************************
            objMsg("Construindo Indice da Tabela " + "ESCALONADA_BLOQUEIO_DESCONTO", numeroTabelasTotal, numeroTabelaAtual++, null);
            CriaIndiceBanco("ESCALONADA_BLOQUEIO_DESCONTO", "IDX_ESCALONADA_BLOQUEIO_DESCONTO", "CODIGO_ESCALONADA_BLOQUEIO, COD_EMPREGADO, COD_PRODUTO, COD_GRUPO, COD_FAMILIA_PRODUTO, NUM_SEQUENCIA_ESCALONADA");
            //************** Fim Construindo Indice da tabela ESCALONADA_BLOQUEIO_DESCONTO *************************

            //************** Inicio Construindo Indice da tabela TABELA_CATEGORIA_ESCALONADA_BLOQUEIO_DESCONTO *************************
            objMsg("Construindo Indice da Tabela " + "TABELA_CATEGORIA_ESCALONADA_BLOQUEIO_DESCONTO", numeroTabelasTotal, numeroTabelaAtual++, null);
            CriaIndiceBanco("TABELA_CATEGORIA_ESCALONADA_BLOQUEIO_DESCONTO", "IDX_TABELA_CATEGORIA_ESCALONADA_BLOQUEIO_DESCONTO", "CODIGO_ESCALONADA_BLOQUEIO, COD_CATEGORIA, COD_TABELA_PRECO");
            //************** Fim Construindo Indice da tabela TABELA_CATEGORIA_ESCALONADA_BLOQUEIO_DESCONTO *************************
