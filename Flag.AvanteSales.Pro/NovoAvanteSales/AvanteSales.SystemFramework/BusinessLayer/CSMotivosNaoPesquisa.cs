    ...
    public class CSMotivosNaoPesquisa : CollectionBase
    {
        ...
        public bool Flush()
        {
            ...
            string sqlQueryInsert =
                ...
                "  (COD_PESQUISA_PIV, COD_PDV, COD_MOTIVO, COD_TIPO_MOTIVO, COD_EMPREGADO, DAT_COLETA, IND_DESCARREGADO) " +
                "  VALUES (?,?,?,?,?,?,0) ";
        ...
        public bool FlushMercado()
        {
            ...
            string sqlQueryInsert =
                ...
                "  (COD_PESQUISA_MERC, COD_PDV, COD_MOTIVO, COD_TIPO_MOTIVO, DAT_COLETA, COD_EMPREGADO, IND_DESCARREGADO) " +
                "  VALUES (?,?,?,?,?,?,0) ";
