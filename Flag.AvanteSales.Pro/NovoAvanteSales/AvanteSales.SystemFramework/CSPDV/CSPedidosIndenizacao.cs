    ...
    public class CSPedidosIndenizacao : CollectionBase, IDisposable
    {
        ...
        public bool Flush()
        {
            ...
            string sqlQueryInsert =
                ...
                "  (COD_PEDIDO, COD_EMPREGADO, NUM_DOCDVL_IDZ, COD_SERDOCDVL_IDZ, VLR_DOCDVL_IDZ, DAT_EMSDLCDVL_IDZ, NUM_VOLDOCDVL_IDZ, COD_MTVDTN_IDZ, COD_TPOMTVDTN_IDZ, COD_MTVCNDRTR_IDZ, COD_TPOMTVCNDRTR_IDZ, COD_MTVRESPBM_IDZ, COD_TPOMTVRESPBM_IDZ, NUM_PEDCET_IDZ, NOM_CNT_IDZ, IND_DESCARREGADO) " +
                "  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,0) ";
